export declare enum RecognitionAPI {
    BingSpeech = 0,
    CustomSpeech = 1,
}
...
export declare class RecognizerConfig {
    ...
    private endpointId;
    constructor(platformConfig: SpeechConfig, recognitionMode: RecognitionMode, language: string, format: SpeechResultFormat, recognitionAPI: RecognitionAPI, endpointId: string);
    ...
    readonly RecognitionAPI: RecognitionAPI;
