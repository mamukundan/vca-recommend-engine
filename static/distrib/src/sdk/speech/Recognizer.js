        ...
        this.SendAudio = function (requestId, connection, audioStreamNode, requestSession) {
            ...
            var readAndUploadCycle = function (_) {
                audioStreamNode.Read().On(function (audioStreamChunk) {
                    ...
                    if (_this.tempBuffer) {
                        _this.tempBuffer = _this.appendBuffer(_this.tempBuffer, payload);
                    }
                    else {
                        _this.tempBuffer = new ArrayBuffer(payload.byteLength);
                        _this.tempBuffer = payload;
                    }
                    console.log("temp buffer" + _this.tempBuffer);
